...
})()(
  {
    1: [
      function(t, e, r) {
        e.exports = [
          ...
          { constant: !1, inputs: [{ name: '_name', type: 'bytes32' }], name: 'disown', outputs: [], type: 'function' },
          {
            anonymous: !1,
            inputs: [
            ...
            if (c !== s) {
              ...
              if (e.isDynamicArray(u))
                for (var p = c === i ? 2 : 0, h = 0; h < r.length; h++)
                  c === i ? (p += +r[h - 1][0] || 0) : c === a && (p += +(r[h - 1] || [])[0] || 0),
        ...
        var n = t('bignumber.js'),
          ...
          c = function(t) {
            ...
            return '1' === new n(e.substr(0, 1), 16).toString(2).substr(0, 1)
              ? new n(e, 16)
                  .minus(new n('ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff', 16))
                  .minus(1)
              : new n(e, 16);
          },
          u = function(t) {
      ...
      function(t, e, r) {
        ...
        e.exports = function(t, e) {
          return (
            e &&
              'hex' === e.encoding &&
              (t.length > 2 && '0x' === t.substr(0, 2) && (t = t.substr(2)), (t = n.enc.Hex.parse(t))),
      ...
      function(t, e, r) {
        var n = t('bignumber.js'),
          ...
          l = function(t) {
            ...
            if (void 0 === e)
              throw new Error(
                "This unit doesn't exists, please use the one of the following units" + JSON.stringify(a, null, 2),
              );
            return new n(e, 10);
          },
          p = function(t) {
        ...
        e.exports = {
          ...
          toTwosComplement: function(t) {
            var e = p(t).round();
            return e.lessThan(0)
              ? new n('ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff', 16).plus(e).plus(1)
              : e;
          },
          ...
          isAddress: function(t) {
            return (
              ...
              (!(!/^(0x)?[0-9a-f]{40}$/.test(t) && !/^(0x)?[0-9A-F]{40}$/.test(t)) || d(t))
            );
          },
          isChecksumAddress: d,
      ...
      function(t, e, r) {
        ...
        var x = function() {
          return [
            ...
            new g({ name: 'version.network', getter: 'net_version', inputFormatter: h.toDecimal }),
            new g({ name: 'version.ethereum', getter: 'eth_protocolVersion', inputFormatter: h.toDecimal }),
        ...
        (u.prototype.encode = function(t) {
          ...
          (u.prototype.execute = function(t, e) {
            a.isFunction(arguments[arguments.length - 1]) &&
              ((e = arguments[arguments.length - 1]), 1 === arguments.length && (t = null));
            var r = this.encode(t),
          ...
          p = function(t, e) {
            (this.eth = t),
              ...
              (this.new = function() {
                ...
                var a = i[i.length - 1];
                if (
                  (n.isObject(a) && !n.isArray(a) && (o = i.pop()), o.value > 0) &&
                  !(
                    e.filter(function(t) {
      ...
      function(t, e, r) {
        e.exports = {
          ...
          InvalidResponse: function(t) {
            var e =
              t && t.error && t.error.message ? t.error.message : 'Invalid JSON RPC response: ' + JSON.stringify(t);
            return new Error(e);
          },
          ...
          outputSyncingFormatter: function(t) {
            return t
              ? ((t.startingBlock = n.toDecimal(t.startingBlock)),
                ...
                t.knownStates &&
                  ((t.knownStates = n.toDecimal(t.knownStates)), (t.pulledStates = n.toDecimal(t.pulledStates))),
                t)
              : t;
          },
        };
      ...
      function(t, e, r) {
        ...
        (c.prototype.extractCallback = function(t) {
          ...
          (c.prototype.toPayload = function(t) {
            var e = {};
            return (
              t.length > this._inputTypes.length && o.isObject(t[t.length - 1]) && (e = t[t.length - 1]),
              this.validateArgs(t),
              (e.to = this._address),
          ...
          (c.prototype.request = function() {
            ...
            return { method: this._constant ? 'eth_call' : 'eth_sendTransaction', callback: e, params: [r], format: n };
          }),
    ...
    32: [
      function(t, e, r) {
        ...
        (i.prototype.prepareRequest = function(t) {
          var e;
          if (
            (t ? ((e = new o()).timeout = this.timeout) : (e = new XMLHttpRequest()),
          ...
          (i.prototype._timeout = function() {
            for (var t in this.responseCallbacks)
              this.responseCallbacks.hasOwnProperty(t) &&
                (this.responseCallbacks[t](o.InvalidConnection('on IPC')), delete this.responseCallbacks[t]);
          }),
          (i.prototype.isConnected = function() {
            return this.connection.writable || this.connection.connect({ path: this.path }), !!this.connection.writable;
          }),
          (i.prototype.send = function(t) {
      ...
      function(t, e, r) {
        ...
        var w = function() {
            var t = new i({
              ...
              k = new i({ name: 'sign', call: 'eth_sign', params: 2, inputFormatter: [n.inputAddressFormatter, null] });
            return [
              t,
              e,
              r,
              ...
              w,
              k,
              new i({ name: 'compile.solidity', call: 'eth_compileSolidity', params: 1 }),
              new i({ name: 'compile.lll', call: 'eth_compileLLL', params: 1 }),
              new i({ name: 'compile.serpent', call: 'eth_compileSerpent', params: 1 }),
          ...
          x = function() {
            return [
              ...
              new a({ name: 'hashrate', getter: 'eth_hashrate', outputFormatter: o.toDecimal }),
              new a({ name: 'syncing', getter: 'eth_syncing', outputFormatter: n.outputSyncingFormatter }),
              new a({ name: 'gasPrice', getter: 'eth_gasPrice', outputFormatter: n.outputBigNumberFormatter }),
              new a({ name: 'accounts', getter: 'eth_accounts' }),
              new a({ name: 'blockNumber', getter: 'eth_blockNumber', outputFormatter: o.toDecimal }),
        ...
        var n = t('../../utils/utils'),
          ...
          i = function() {
            return [
              ...
              new o({ name: 'peerCount', getter: 'net_peerCount', outputFormatter: n.toDecimal }),
            ];
          };
        e.exports = function(t) {
          this._requestManager = t._requestManager;
    ...
    40: [
      function(t, e, r) {
        ...
        var n = t('../method'),
          ...
          i = t('../formatters');
        var a = function() {
            var t = new n({ name: 'newAccount', call: 'personal_newAccount', params: 1, inputFormatter: [null] }),
      ...
      function(t, e, r) {
        ...
        var s = function() {
          return [
            ...
            new n({ name: 'setMaxMessageSize', call: 'shh_setMaxMessageSize', params: 1 }),
            ...
            new n({ name: 'generateSymKeyFromPassword', call: 'shh_generateSymKeyFromPassword', params: 1 }),
    ...
    42: [
      function(t, e, r) {
        ...
        var i = function() {
            return [
              new n({ name: 'blockNetworkRead', call: 'bzz_blockNetworkRead', params: 1, inputFormatter: [null] }),
              new n({ name: 'syncEnabled', call: 'bzz_syncEnabled', params: 1, inputFormatter: [null] }),
              new n({ name: 'swapEnabled', call: 'bzz_swapEnabled', params: 1, inputFormatter: [null] }),
              new n({ name: 'download', call: 'bzz_download', params: 2, inputFormatter: [null, null] }),
              new n({ name: 'upload', call: 'bzz_upload', params: 2, inputFormatter: [null, null] }),
              new n({ name: 'retrieve', call: 'bzz_retrieve', params: 1, inputFormatter: [null] }),
              new n({ name: 'store', call: 'bzz_store', params: 2, inputFormatter: [null, null] }),
              new n({ name: 'get', call: 'bzz_get', params: 1, inputFormatter: [null] }),
              new n({ name: 'put', call: 'bzz_put', params: 2, inputFormatter: [null, null] }),
              new n({ name: 'modify', call: 'bzz_modify', params: 4, inputFormatter: [null, null, null, null] }),
            ];
          },
          a = function() {
        ...
        e.exports = {
          eth: function() {
            return [
              ...
              new n({ name: 'uninstallFilter', call: 'eth_uninstallFilter', params: 1 }),
          ...
          shh: function() {
            return [
              ...
              new n({ name: 'uninstallFilter', call: 'shh_deleteMessageFilter', params: 1 }),
      ...
      function(t, e, r) {
        ...
        (o.prototype.buildGet = function() {
          ...
          (o.prototype.buildAsyncGet = function() {
            var t = this,
              e = function(e) {
                t.requestManager.sendAsync({ method: t.getter }, function(r, n) {
      ...
      function(t, e, r) {
        ...
        (s.prototype.send = function(t) {
          ...
          (s.prototype.startPolling = function(t, e, r, n) {
            (this.polls[e] = { data: t, id: e, callback: r, uninstall: n }), this.timeout || this.poll();
          }),
          ...
          (s.prototype.poll = function() {
            if (
              ((this.timeout = setTimeout(this.poll.bind(this), i.ETH_POLLING_TIMEOUT)),
              0 !== Object.keys(this.polls).length)
            )
              if (this.provider) {
                var t = [],
    ...
    50: [
      function(t, e, r) {
        ...
        (n = this),
                ...
                var d = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
                  m = (n.AES = r.extend({
                      ...
                      if (!this._nRounds || this._keyPriorReset !== this._key) {
                        ...
                        for (var c = (this._invKeySchedule = []), u = 0; u < n; u++) {
                          ...
                          c[u] =
                            u < 4 || a <= 4
                              ? s
                              : f[o[s >>> 24]] ^ l[o[(s >>> 16) & 255]] ^ p[o[(s >>> 8) & 255]] ^ h[o[255 & s]];
                        }
                      }
                    },
                    ...
                    _doCryptBlock: function(t, e, r, n, o, i, a, s) {
                      ...
                      (m =
                        ((s[u >>> 24] << 24) | (s[(f >>> 16) & 255] << 16) | (s[(l >>> 8) & 255] << 8) | s[255 & p]) ^
                        r[h++]),
                        (y =
                          ((s[f >>> 24] << 24) | (s[(l >>> 16) & 255] << 16) | (s[(p >>> 8) & 255] << 8) | s[255 & u]) ^
                          r[h++]),
                        (g =
                          ((s[l >>> 24] << 24) | (s[(p >>> 16) & 255] << 16) | (s[(u >>> 8) & 255] << 8) | s[255 & f]) ^
                          r[h++]),
                        (v =
                          ((s[p >>> 24] << 24) | (s[(u >>> 16) & 255] << 16) | (s[(f >>> 8) & 255] << 8) | s[255 & l]) ^
                          r[h++]);
          ...
          'object' == typeof r
            ? (e.exports = r = o(t('./core'), t('./enc-base64'), t('./md5'), t('./evpkdf'), t('./cipher-core')))
            : 'function' == typeof define && define.amd
              ? define(['./core', './enc-base64', './md5', './evpkdf', './cipher-core'], o)
              : o(n.CryptoJS);
      },
          ...
          (o = function(t) {
            ...
            t.lib.Cipher ||
              ...
              (d = (r.pad = {}).Pkcs7 = {
                pad: function(t, e) {
                  for (
                    var r = 4 * e, n = r - (t.sigBytes % r), o = (n << 24) | (n << 16) | (n << 8) | n, a = [], s = 0;
                    s < n;
                    s += 4
                  )
                    a.push(o);
              ...
              (v = (r.kdf = {}).OpenSSL = {
                execute: function(t, e, r, n) {
                  ...
                  return (o.sigBytes = 4 * e), m.create({ key: o, iv: a, salt: n });
                },
              }),
            ...
            (r = (e = t).lib.Base),
              ...
              (e.algo.HMAC = r.extend({
                init: function(t, e) {
                  ...
                  for (
                    var i = (this._oKey = e.clone()), a = (this._iKey = e.clone()), s = i.words, c = a.words, u = 0;
                    u < r;
                    u++
                  )
                ...
                var c = (a.MD5 = i.extend({
                  ...
                  _doProcessBlock: function(t, e) {
                    ...
                    (F = p(
                      (F = p(
                        (F = p(
                          (F = p(
                            (F = l(
                              (F = l(
                                (F = l(
                                  (F = l(
                                    (F = f(
                                      (F = f(
                                        (F = f(
                                          (F = f(
                                            (F = u(
                                              (F = u(
                                                (F = u(
                                                  (F = u(
                                                    ...
                                                    (O = u(
                                                      O,
                                                      (I = u(I, (C = u(C, F, O, I, a, 7, s[0])), F, O, c, 12, s[1])),
                                                      C,
                                                      F,
                                                      h,
                                                      17,
                                                  ...
                                                  (O = u(
                                                    O,
                                                    (I = u(I, (C = u(C, F, O, I, m, 7, s[4])), F, O, y, 12, s[5])),
                                                    C,
                                                    F,
                                                    g,
                                                    17,
                                                ...
                                                (O = u(
                                                  O,
                                                  (I = u(I, (C = u(C, F, O, I, b, 7, s[8])), F, O, _, 12, s[9])),
                                                  C,
                                                  F,
                                                  w,
                                                  17,
                                              ...
                                              (O = u(
                                                O,
                                                (I = u(I, (C = u(C, F, O, I, k, 7, s[12])), F, O, B, 12, s[13])),
                                                C,
                                                F,
                                                S,
                                                17,
                                            ...
                                            (O = f(
                                              O,
                                              (I = f(I, (C = f(C, F, O, I, c, 5, s[16])), F, O, g, 9, s[17])),
                                              C,
                                              F,
                                              x,
                                              14,
                                          ...
                                          (O = f(
                                            O,
                                            (I = f(I, (C = f(C, F, O, I, y, 5, s[20])), F, O, w, 9, s[21])),
                                            C,
                                            F,
                                            A,
                                            14,
                                        ...
                                        (O = f(
                                          O,
                                          (I = f(I, (C = f(C, F, O, I, _, 5, s[24])), F, O, S, 9, s[25])),
                                          C,
                                          F,
                                          d,
                                          14,
                                      ...
                                      (O = f(
                                        O,
                                        (I = f(I, (C = f(C, F, O, I, B, 5, s[28])), F, O, h, 9, s[29])),
                                        C,
                                        F,
                                        v,
                                        14,
                                    ...
                                    (O = l(
                                      O,
                                      (I = l(I, (C = l(C, F, O, I, y, 4, s[32])), F, O, b, 11, s[33])),
                                      C,
                                      F,
                                      x,
                                      16,
                                  ...
                                  (O = l(
                                    O,
                                    (I = l(I, (C = l(C, F, O, I, c, 4, s[36])), F, O, m, 11, s[37])),
                                    C,
                                    F,
                                    v,
                                    16,
                                ...
                                (O = l(
                                  O,
                                  (I = l(I, (C = l(C, F, O, I, B, 4, s[40])), F, O, a, 11, s[41])),
                                  C,
                                  F,
                                  d,
                                  16,
                              ...
                              (O = l(
                                O,
                                (I = l(I, (C = l(C, F, O, I, _, 4, s[44])), F, O, k, 11, s[45])),
                                C,
                                F,
                                A,
                                16,
                            ...
                            (O = p(
                              O,
                              (I = p(I, (C = p(C, F, O, I, a, 6, s[48])), F, O, v, 10, s[49])),
                              C,
                              F,
                              S,
                              15,
                          ...
                          (O = p(
                            O,
                            (I = p(I, (C = p(C, F, O, I, k, 6, s[52])), F, O, d, 10, s[53])),
                            C,
                            F,
                            w,
                            15,
                        ...
                        (O = p(
                          O,
                          (I = p(I, (C = p(C, F, O, I, b, 6, s[56])), F, O, A, 10, s[57])),
                          C,
                          F,
                          g,
                          15,
                      ...
                      (O = p(O, (I = p(I, (C = p(C, F, O, I, m, 6, s[60])), F, O, x, 10, s[61])), C, F, h, 15, s[62])),
                      I,
                      C,
                      _,
                      21,
                ...
                var e = t,
                  ...
                  s = (n.RabbitLegacy = r.extend({
                    ...
                    _doProcessBlock: function(t, e) {
                      ...
                      for (var n = 0; n < 4; n++)
                        (o[n] =
                          (16711935 & ((o[n] << 8) | (o[n] >>> 24))) | (4278255360 & ((o[n] << 24) | (o[n] >>> 8)))),
                          (t[e + n] ^= o[n]);
                    },
                    blockSize: 4,
                    ivSize: 2,
                  ...
                  s = (n.Rabbit = r.extend({
                    _doReset: function() {
                      for (var t = this._key.words, e = this.cfg.iv, r = 0; r < 4; r++)
                        t[r] =
                          (16711935 & ((t[r] << 8) | (t[r] >>> 24))) | (4278255360 & ((t[r] << 24) | (t[r] >>> 8)));
                      var n = (this._X = [
                          t[0],
                          (t[3] << 16) | (t[2] >>> 16),
                          t[1],
              ...
              (function(e) {
                ...
                !(function() {
                  ...
                  for (var n = 2, o = 0; o < 64; )
                    t(n) && (o < 8 && (s[o] = r(e.pow(n, 0.5))), (c[o] = r(e.pow(n, 1 / 3))), o++), n++;
                })();
                var u = [],
                  f = (a.SHA256 = i.extend({
                    _doReset: function() {
                    ...
                    for (var s = 0; s < 24; s++) {
                      ...
                      for (p = 0; p < 5; p++) {
                        var g = l[(p + 4) % 5],
                          ...
                          _ = v.low;
                        for (
                          h = g.high ^ ((b << 1) | (_ >>> 31)), d = g.low ^ ((_ << 1) | (b >>> 31)), m = 0;
                          m < 5;
                          m++
                        ) {
                    ...
                    _doReset: function() {
                      ...
                      for (var o = (this._subKeys = []), i = 0; i < 16; i++) {
                        var u = (o[i] = []),
                          f = c[i];
                        for (r = 0; r < 24; r++)
                          (u[(r / 6) | 0] |= e[(s[r] - 1 + f) % 28] << (31 - (r % 6))),
                            (u[4 + ((r / 6) | 0)] |= e[28 + ((s[r + 24] - 1 + f) % 28)] << (31 - (r % 6)));
                        u[0] = (u[0] << 1) | (u[0] >>> 31);
            ...
            decode: function(t) {
              ...
              return (function(t) {
                for (var e, r = t.length, n = -1, o = ''; ++n < r; )
                  (e = t[n]) > 65535 && ((o += u((((e -= 65536) >>> 10) & 1023) | 55296)), (e = 56320 | (1023 & e))),
                    (o += u(e));
                return o;
              })(r);
            },
        ...
        !(function(t) {
          ...
          ((r = (function t(e) {
            ...
            function X(t, e) {
              ...
              if (null != e && U(e, 2, 64, P, 'base')) {
                ...
                if (
                  ...
                  !new RegExp('^-?' + (r = '[' + u.slice(0, e) + ']+') + '(?:\\.' + r + ')?$', e < 37 ? 'i' : '').test(
                    h,
                  )
                )
                  return S(d, h, s, e);
              ...
              for (
                (o = h.indexOf('.')) > -1 && (h = h.replace('.', '')),
                  (a = h.search(/e/i)) > 0
                    ? (o < 0 && (o = a), (o += +h.slice(a + 1)), (h = h.substring(0, a)))
                    : o < 0 && (o = h.length),
                  a = 0;
                48 === h.charCodeAt(a);
                a++
              ...
              if ((h = h.slice(a, f + 1)))
                if (
                  ((f = h.length), s && L && f > 15 && (t > p || t !== i(t)) && tt(P, c, d.s * t), (o = o - a - 1) > z)
                )
                  d.c = d.e = null;
            ...
            function $(t, e, n, o) {
              ...
              if (!l[0]) return '0';
              if (
                (h < 0 ? --a : ((f.c = l), (f.e = a), (f.s = o), (l = (f = r(f, p, d, m, e)).c), (c = f.r), (a = f.e)),
                (h = l[(i = a + d + 1)]),
                (s = e / 2),
                (c = c || i < 0 || null != l[i + 1]),
                (c =
                  m < 4
                    ...
                    : h > s || (h == s && (4 == m || c || (6 == m && 1 & l[i - 1]) || m == (f.s < 0 ? 8 : 7)))),
                i < 1 || !l[0])
              )
                t = c ? k('1', -d) : '0';
              else {
            ...
            function Y(t, e, r, n, o) {
              return (
                (t < e || t > r || t != B(t)) &&
                  tt(n, (o || 'decimal places') + (t < e || t > r ? ' out of range' : ' not an integer'), t),
                !0
              );
            }
            function Q(t, e, r) {
              ...
              return (
                (r = n + r * l - 1) > z ? (t.c = t.e = null) : r < q ? (t.c = [(t.e = 0)]) : ((t.e = r), (t.c = e)), t
              );
            }
            function tt(t, e, r) {
              var n = new Error(
            ...
            function et(t, e, r, n) {
              ...
              if (y) {
                t: {
                  ...
                  if (
                    ((n = n || e < 0 || null != y[d + 1] || (c < 0 ? p : p % g[a - c - 1])),
                    (n =
                      r < 4
                        ? (m || n) && (0 == r || r == (t.s < 0 ? 3 : 2))
                        : m > 5 ||
                          (5 == m &&
                            (4 == r ||
                              n ||
                              (6 == r && (s > 0 ? (c > 0 ? p / g[a - c] : 0) : y[d - 1]) % 10 & 1) ||
                              r == (t.s < 0 ? 8 : 7)))),
                    e < 1 || !y[0])
                  )
                    return (
                      (y.length = 0),
                      n ? ((e -= t.e + 1), (y[0] = g[(l - (e % l)) % l]), (t.e = -e || 0)) : (y[0] = t.e = 0),
                      t
                    );
                  if (
                    (0 == s
                      ? ((y.length = d), (u = 1), d--)
                      : ((y.length = d + 1), (u = g[l - s]), (y[d] = c > 0 ? i((p / g[a - c]) % g[c]) * u : 0)),
                    n)
                  )
                    for (;;) {
                      if (0 == d) {
            ...
            return (
              ...
              (X.config = X.set = function() {
                ...
                return (
                  s((e = 'DECIMAL_PLACES')) && U(t, 0, m, 2, e) && (E = 0 | t),
                  (n[e] = E),
                  s((e = 'ROUNDING_MODE')) && U(t, 0, 8, 2, e) && (M = 0 | t),
                  (n[e] = M),
                  s((e = 'EXPONENTIAL_AT')) &&
                    (_(t)
                      ? U(t[0], -m, 0, 2, e) && U(t[1], 0, m, 2, e) && ((H = 0 | t[0]), (j = 0 | t[1]))
                      : U(t, -m, m, 2, e) && (H = -(j = 0 | (t < 0 ? -t : t)))),
                  (n[e] = [H, j]),
                  s((e = 'RANGE')) &&
                    (_(t)
                      ? U(t[0], -m, -1, 2, e) && U(t[1], 1, m, 2, e) && ((q = 0 | t[0]), (z = 0 | t[1]))
                      : U(t, -m, m, 2, e) &&
                        (0 | t ? (q = -(z = 0 | (t < 0 ? -t : t))) : L && tt(2, e + ' cannot be zero', t))),
                  (n[e] = [q, z]),
                  s((e = 'ERRORS')) &&
                    (t === !!t || 1 === t || 0 === t ? ((P = 0), (U = (L = !!t) ? Y : b)) : L && tt(2, e + a, t)),
                  (n[e] = L),
                  s((e = 'CRYPTO')) &&
                    (!0 === t || !1 === t || 1 === t || 0 === t
                      ? t
                  ...
                  if (crypto.getRandomValues) {
                    for (e = crypto.getRandomValues(new Uint32Array((a *= 2))); c < a; )
                      (s = 131072 * e[c] + (e[c + 1] >>> 11)) >= 9e15
                        ? ((r = crypto.getRandomValues(new Uint32Array(2))), (e[c] = r[0]), (e[c + 1] = r[1]))
                        : (u.push(s % 1e14), (c += 2));
                    c = a / 2;
              ...
              (r = (function() {
                function t(t, e, r) {
                  ...
                  for (t = t.slice(); c--; )
                    (s =
                      (((o = u * (i = t[c] % d) + ((n = f * i + (a = (t[c] / d) | 0) * u) % d) * d + s) / r) | 0) +
                      ((n / d) | 0) +
                      f * a),
                      (t[c] = o % r);
                ...
                return function(n, o, a, s, c) {
                  ...
                  if (!(I && I[0] && N && N[0]))
                    return new X(
                      n.s && o.s && (I ? !N || I[0] != N[0] : N) ? ((I && 0 == I[0]) || !N ? 0 * O : O / 0) : NaN,
                    );
                  for (
                    _ = (b = new X(O)).c = [],
                      O = a + (p = n.e - o.e) + 1,
                      c || ((c = f), (p = y(n.e / l) - y(o.e / l)), (O = (O / l) | 0)),
                      h = 0;
                    N[h] == (I[h] || 0);
                    h++
                  );
                  if ((N[h] > (I[h] || 0) && p--, O < 0)) _.push(1), (d = !0);
                    ...
                    for (
                      S = I.length,
                        ...
                        O += 2,
                        (m = i(c / (N[0] + 1))) > 1 &&
                          ((N = t(N, m, c)), (I = t(I, m, c)), (C = N.length), (S = I.length)),
                        B = C,
                    ...
                    do {
                      if (((m = 0), (u = e(N, w, C, x)) < 0)) {
                        ...
                        if ((v < x && (g = [0].concat(g)), r(w, g, x, c), (x = w.length), -1 == u))
                          for (; e(N, w, C, x) < 1; ) m++, r(w, C < x ? F : N, x, c), (x = w.length);
                      } else 0 === u && (m++, (w = [0]));
                ...
                return (
                  ...
                  !i.c || !t.s || (t.c && !t.c[0])
                    ...
                    : !t.c || (i.c && !i.c[0])
                      ? new X(i)
                      : (9 == J
                          ? ((o = t.s), (t.s = 1), (n = r(i, t, 0, 3)), (t.s = o), (n.s *= o))
                          : (n = r(i, t, 0, J)),
                        i.minus(n.times(t)))
                );
              }),
              ...
              (D.round = function(t, e) {
                var r = new X(this);
                return (
                  (null == t || U(t, 0, m, 15)) && et(r, ~~t + this.e + 1, null != e && U(e, 0, 8, 15, s) ? 0 | e : M),
                  r
                );
              }),
              (D.shift = function(t) {
                ...
                return U(t, -p, p, 16, 'argument')
                  ? e.times('1e' + B(t))
                  : new X(e.c && e.c[0] && (t < -p || t > p) ? e.s * (t < 0 ? 0 : 1 / 0) : e);
              }),
                ...
                if (
                  (0 == (c = Math.sqrt(+a)) || c == 1 / 0
                    ? (((e = g(s)).length + u) % 2 == 0 && (e += '0'),
                      ...
                      (u = y((u + 1) / 2) - (u < 0 || u % 2)),
                      (n = new X(
                        (e = c == 1 / 0 ? '1e' + u : (e = c.toExponential()).slice(0, e.indexOf('e') + 1) + u),
                      )))
                    : (n = new X(c + '')),
                  n.c[0])
                )
                  for ((c = (u = n.e) + f) < 3 && (c = 0); ; )
                    if (
                      ((i = n), (n = l.times(i.plus(r(a, i, f, 1)))), g(i.c).slice(0, c) === (e = g(n.c)).slice(0, c))
                    ) {
              ...
              (D.times = D.mul = function(t, e) {
                ...
                if (!(x && k && x[0] && k[0]))
                  return (
                    !w.s || !t.s || (x && !x[0] && !k) || (k && !k[0] && !x)
                      ? (t.c = t.e = t.s = null)
                      : ((t.s *= w.s), x && k ? ((t.c = [0]), (t.e = 0)) : (t.c = t.e = null)),
                    t
                  );
                for (
                  n = y(w.e / l) + y(t.e / l),
                    t.s *= w.s,
                    (c = x.length) < (h = k.length) && ((v = x), (x = k), (k = v), (o = c), (c = h), (h = o)),
                    o = c + h,
                    v = [];
                  o--;
                  v.push(0)
                ...
                for (b = f, _ = d, o = h; --o >= 0; ) {
                  for (r = 0, m = k[o] % _, g = (k[o] / _) | 0, i = o + (a = c); i > o; )
                    (r =
                      (((u = m * (u = x[--a] % _) + ((s = g * u + (p = (x[a] / _) | 0) * m) % _) * _ + v[i] + r) / b) |
                        0) +
                      ((s / _) | 0) +
                      g * p),
                      (v[i--] = u % b);
                  ...
                  r = u
                    ? c +
                      ...
                      ((a = +G.fractionGroupSize)
                        ? u.replace(new RegExp('\\d{' + a + '}\\B', 'g'), '$&' + G.fractionGroupSeparator)
                        : u)
                    : c;
                }
                return r;
              ...
              (D.toFraction = function(t) {
                ...
                if (
                  (null != t &&
                    ...
                    (L = p),
                    ((p = s.isInt()) && !s.lt(R)) ||
                      (L && tt(22, 'max denominator ' + (p ? 'out of range' : 'not an integer'), t),
              ...
              (D.toPower = D.pow = function(t, e) {
                ...
                if (
                  ...
                  (!U(t, -p, p, 23, 'exponent') &&
                    (!isFinite(t) || (s > p && (t /= 0)) || (parseFloat(t) != t && !(t = NaN)))) ||
                    0 == t)
                )
              ...
              (D.valueOf = D.toJSON = function() {
                ...
                return null === e
                  ? this.toString()
                  : ((t = g(this.c)), (t = e <= H || e >= j ? x(t, e) : k(t, e)), this.s < 0 ? '-' + t : t);
              }),
              (D.isBigNumber = !0),
              null != e && X.config(e),
              X
            ...
            'function' == typeof define && define.amd
              ...
              : void 0 !== e && e.exports
                ? (e.exports = r)
                : (t || (t = 'undefined' != typeof self ? self : Function('return this')()), (t.BigNumber = r));
        })(this);
      },
      {},
    ],
